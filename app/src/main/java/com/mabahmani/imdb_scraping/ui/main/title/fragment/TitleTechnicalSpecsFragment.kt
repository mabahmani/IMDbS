...
import com.mabahmani.imdb_scraping.ui.main.title.adapter.TitleDetailsTechnicalSpecsAdapter
    ...
    private fun setOnClickListeners() {
        binding.titleCover.setOnClickListener{
            findNavController().navigate(
                ...
                Bundle().apply {
                    putString("imageUrl", titleTechnicalSpecs.cover.getOriginalImageSizeUrl())
                    putString("title", titleTechnicalSpecs.name)
                }
            )
        }
    }
    ...
    private fun handleTitleTechnicalSpecsStates(state: TitleTechnicalSpecsUiState) {
        when (state) {
            ...
            is TitleTechnicalSpecsUiState.ShowTitleTechnicalSpecs -> {
                titleTechnicalSpecs = state.titleTechnicalSpecs
