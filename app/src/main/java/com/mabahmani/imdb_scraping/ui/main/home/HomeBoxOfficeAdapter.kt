...
class HomeBoxOfficeAdapter(private val itemClickListener: (BoxOffice.BoxOfficeItem) -> Unit) : ListAdapter<BoxOffice.BoxOfficeItem, HomeBoxOfficeAdapter.ViewHolder>(DiffCallback) {
