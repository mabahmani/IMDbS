package com.mabahmani.imdb_scraping.ui.main.video.adapter
...
class VideoDetailsRelatedVideosAdapter(private val itemClickListener: (Video) -> Unit) : ListAdapter<Video, VideoDetailsRelatedVideosAdapter.ViewHolder>(
    DiffCallback
) {
